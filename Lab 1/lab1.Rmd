...
## Lalonde Dataset
- Load the `lalonde` dataset from (Imbens & Wu, 2025)[https://pubs.aeaweb.org/doi/pdfplus/10.1257/jep.20251440]. Complete replication package available (here)[https://www.openicpsr.org/openicpsr/project/232201/version/V1/view?path=/openicpsr/232201/fcr:versions/V1/replication] and addition tutorial (here)[https://yiqingxu.org/tutorials/lalonde/].
